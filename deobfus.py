...
def Main():
    ...
    global proxy
    ver = "73"
    version = requests.post("https://rainbow-t-shirt.com/spymer/version.php").json()[
        "version"
    ]
    if int(ver) < int(version):
        info = (
            Back.RED
            + "\nThe version is outdated and needs to be updated!"
            + Style.RESET_ALL
        )
    else:
        info = " "
                    ...
                    try:
                        if int(phone):
                            ...
                            try:
                                ...
                                info = (
                                    Fore.RED
                                    + "\nIncorrect number of cycles entered!"
                                    + Style.RESET_ALL
                                )
                    except:
                ...
                try:
                    if int(phone):
                        ...
                        if int(id) > 0:
                            ...
                            requests.post(
                                "https://rainbow-t-shirt.com/spymer/ajax.php",
                                data={"phone": phone},
                            )
                            info = (
                                Fore.GREEN
                                + "\nPhone {} added to the antispam list.".format(phone)
                                + Style.RESET_ALL
                            )
                    ...
                    info = (
                        Fore.RED
                        + "\nIncorrect phone entered!".format(phone)
                        + Style.RESET_ALL
                    )
                ...
                try:
                    if int(phone):
                        ...
                        if int(id) > 0:
                            info = (
                                Fore.GREEN
                                + "\nPhone {} is in antispam list.".format(phone)
                                + Style.RESET_ALL
                            )
                        elif int(id) == 0:
                            info = (
                                Fore.RED
                                + "\nPhone {} is not in antispam list.".format(phone)
                                + Style.RESET_ALL
                            )
                except:
                    info = Fore.RED + "\nIncorrect phone entered!" + Style.RESET_ALL
                    ...
                    try:
                        if int(phone):
                            ...
                            if name == "":
                                ...
                                main()
                            print(
                                "Enter complaint (an appeal that the victim allegedly addresses to lawyers):"
                            )
                            text = input(Fore.BLUE + "spymer > " + Style.RESET_ALL)
                            if text == "":
                                info = (
                                    Fore.RED
                                    + "\nIncorrect complaint entered!"
                                    + Style.RESET_ALL
                                )
                                main()
                            try:
                                ...
                                if int(id) > 0:
                                    info = (
                                        Fore.RED
                                        + "\nThe phone is in the antispam list."
                                        + Style.RESET_ALL
                                    )
                                    main()
                                elif int(id) == 0:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            if blablabla.status_code == 200:
                                                print(
                                                    Fore.GREEN
                                                    + "Ñ8eÑ80Ðb8Ñ81Ñ82-Ðb0Ðb2Ðb3Ñ80Ñ83ÐbfÐbf.Ñ80Ñ84: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED
                                                    + "Ñ8eÑ80Ðb8Ñ81Ñ82-Ðb0Ðb2Ðb3Ñ80Ñ83ÐbfÐbf.Ñ80Ñ84: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                        ...
                                        try:
                                            rdftgbhnj = requests.post(
                                                ...
                                                data={
                                                    ...
                                                    "tel-231": _phone,
                                                    "textarea-472": _text,
                                                    "hidden-278": "Ð93ÐbbÐb0Ðb2ÐbdÐb0Ñ8f",
                                                },
                                                proxies=proxies,
                                            )
                                            if rdftgbhnj.status_code == 200:
                                                print(
                                                    Fore.GREEN
                                                    + "Ðb3ÐbeÑ81-Ñ8eÑ80Ðb8Ñ81Ñ82Ñ8b.Ñ80Ñ84: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED
                                                    + "Ðb3ÐbeÑ81-Ñ8eÑ80Ðb8Ñ81Ñ82Ñ8b.Ñ80Ñ84: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                        ...
                                        try:
                                            pravosfera = requests.post(
                                                ...
                                                data={
                                                    ...
                                                    "quest": _text,
                                                    "uest_go": "Ð97Ðb0Ðb4Ðb0Ñ82Ñ8c Ðb2ÐbeÐbfÑ80ÐbeÑ81",
                                                },
                                                proxies=proxies,
                                            )
                                            if usachev.status_code == 200:
                                        ...
                                        try:
                                            uristexpert24 = requests.post(
                                                ...
                                                data={
                                                    "name": _name,
                                                    "phone": _phoneVodaonline,
                                                    "form-name": "Ð97Ðb0ÐbaÐb0Ðb7 ÐbeÐb1Ñ80Ðb0Ñ82ÐbdÐbeÐb3Ðbe Ðb7Ðb2ÐbeÐbdÐbaÐb0",
                                                },
                                                proxies=proxies,
                                            )
                                        ...
                                        try:
                                            ...
                                            if gosurist.status_code == 200:
                                                ...
                                                print(
                                                    Fore.RED
                                                    + "www.gos-urist.ruÑ87Ñ91: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                ...
                                info = (
                                    Fore.RED
                                    + "\nError 4589: send me to Telegram @FSystem88!"
                                    + Style.RESET_ALL
                                )
